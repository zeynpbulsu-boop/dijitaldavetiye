...
const P = THEMES_V2.fener.palette;
...
export function FenerThumb() {
  return (
    <svg viewBox="0 0 300 400" width="100%" height="100%" preserveAspectRatio="xMidYMid slice">
      ...
      {/* Tree left */}
      <g stroke={P.accent} strokeWidth="1" fill="none" opacity="0.7">
      ...
      {/* House right */}
      <g stroke={P.accent} strokeWidth="1.2" fill="none" opacity="0.7">
        <path d="M 180 380 L 180 240 L 230 220 L 280 240 L 280 380" />
        <rect x="220" y="320" width="22" height="60" />
      </g>

      {/* String lights */}
      <path d="M 60 200 Q 150 290 270 220" stroke={P.accent} strokeWidth="0.5" fill="none" opacity="0.5" />
      {[
        [60, 200], [90, 222], [120, 250], [150, 270],
        [180, 270], [210, 256], [240, 240], [270, 220],
      ].map(([x, y], i) => (
        <g key={i}>
          <circle cx={x} cy={y as number + 12} r="14" fill={P.accent} opacity="0.25" />
