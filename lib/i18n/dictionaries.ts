...
const tr: Messages = {
  ...
  pricing: {
    ...
    tiers: [
      {
        name: "NUVE Davetiye",
        note: "Tek seferlik · 12 ay yayında · KDV dahil",
        summary: "Her edisyon. Tek fiyat. Bir yıl canlı.",
        price: 39.99,
        features: [
          "14 edisyon arasından seçim",
          "Sınırsız RSVP",
          "Zarf seremoni + müzik + galeri + harita",
          "Türkçe + İngilizce + Sırpça",
          "Admin paneliyle RSVP takip + CSV indir",
    ...
    items: [
      {
        ...
        a: "12 ay yayında kalır. Süresi dolunca davetiyen otomatik arşivlenir — silinmez. Tek bir mesajla yıllık €4 karşılığında uzatabilir, anı sayfası olarak saklayabilirsin.",
      },
      {
      ...
      },
      {
        ...
        a: "Yedi dil hazır geliyor — Türkçe, İngilizce, Almanca, Fransızca, Boşnakça, Sırpça, Yunanca. Misafirin tarayıcısı hangi dildeyse o görüyor; köşedeki küçük seçiciden değiştirebiliyor. İstersen bireysel çeviri için bize yaz, ek ücretsiz hallederiz.",
      },
    ],
  },
  closing: {
...
const en: Messages = {
  ...
  pricing: {
    ...
    headline_period: ".",
    intro:
      "One price, one package, no math. Whichever edition you choose, your invitation is €39.99 — VAT and processing included.",
    ...
    tiers: [
      {
        name: "NUVE Invitation",
        note: "One-time · live for 12 months · VAT included",
        summary: "Every edition. One price. Live for a year.",
        price: 39.99,
        features: [
          "Choice of 14 editions",
          "Unlimited RSVP",
          "Envelope ceremony + music + gallery + map",
          "Turkish + English + Serbian",
          "Admin panel to track RSVPs + CSV export",
    ...
    items: [
      {
        ...
        a: "Twelve months online. When the term ends, your invitation is archived automatically — never deleted. A single message and we extend it for €4 a year, kept as a memorial page if you like.",
      },
      {
      ...
      },
      {
        ...
        a: "Included in every package. We register the name (yourname.com), set the DNS, install the SSL, and hand you a working link. If you already own a domain, we connect that too.",
      },
      {
      ...
      },
      {
        ...
        a: "Seven languages out of the box — Turkish, English, German, French, Bosnian, Serbian, Greek. Each guest sees the site in their browser language; a small picker in the corner lets them switch. Need an extra language? Write to us — we'll translate it free of charge.",
      },
    ],
  },
  closing: {
...
const sr: Messages = {
  ...
  pricing: {
    ...
    headline_period: ".",
    intro:
      "Jedna cena, jedan paket, bez kalkulacija. Koje god izdanje izaberete, vaša pozivnica je €39,99 — PDV i procesiranje uključeni.",
    ...
    tiers: [
      {
        name: "NUVE Pozivnica",
        note: "Jednokratno · objavljeno 12 meseci · PDV uključen",
        summary: "Svako izdanje. Jedna cena. Godinu dana online.",
        price: 39.99,
        features: [
          "Izbor između 14 izdanja",
          "Neograničen RSVP",
          "Ceremonija koverte + muzika + galerija + mapa",
          "Turski + engleski + srpski",
          "Admin panel za RSVP + CSV izvoz",
    ...
    items: [
      {
        ...
        a: "Dvanaest meseci online. Po isteku se automatski arhivira — nikada se ne briše. Jednom porukom produžavamo za €4 godišnje i čuva se kao memorijalna stranica ako poželite.",
      },
      {
      ...
      },
      {
        ...
        a: "Uključeno u svaki paket. Registrujemo ime (vaseime.com), podešavamo DNS, instaliramo SSL i predajemo vam ispravan link. Ako već imate domen, povezujemo i njega.",
      },
      {
      ...
      },
      {
        ...
        a: "Sedam jezika je odmah dostupno — turski, engleski, nemački, francuski, bosanski, srpski, grčki. Svaki gost vidi sajt na jeziku svog pretraživača; sa malim biračem u uglu može da promeni. Treba vam dodatan jezik? Napišite nam — prevodimo besplatno.",
      },
    ],
  },
  closing: {
