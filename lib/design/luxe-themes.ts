...
export const AETHEL_THEME: LuxeEditionTheme = {
  ...
  verse: "Eski taşların gölgesinde, yeni bir hikâye yazılıyor — bir bal kavanozu, bir söz ve sonsuz bir öğleden sonra.",
  monogram: "D&A",
...
export const NOCTURNE_THEME: LuxeEditionTheme = {
  ...
  verse: "Gece, sözleri sessizce taşır — yıldızlar tanıklık etti, geri kalanı zaman söyleyecek.",
  monogram: "S&M",
...
export const CANDELA_THEME: LuxeEditionTheme = {
  ...
  verse: "Bir kandile dokunan ışık, bin kandile dönüşür — bu akşam, hepsi bizim için yanıyor.",
  monogram: "Z&K",
...
export const MISTRAL_THEME: LuxeEditionTheme = {
  ...
  coupleName: "Ayda & Can",
  verse: "Deniz, en uzun yolculukları kısa bir mektup yapar — bir yelken, bir kıyı, iki imza.",
  monogram: "A&C",
...
export const AURORA_THEME: LuxeEditionTheme = {
  ...
  verse: "Bir başlangıç yeterli — geri kalanını birlikte yazacağız, sayfa sayfa.",
  monogram: "E&Y",
