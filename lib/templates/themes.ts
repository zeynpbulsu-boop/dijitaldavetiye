...
const THEMES: Record<string, InvitationTheme> = {
  ...
  "nocturne": {
    slug: "nocturne",
    name: "Nocturne",
    bg: "linear-gradient(170deg, #0F1A3D 0%, #0A1430 55%, #0F1A3D 100%)",
    ink: "#F2EAD3",
    inkSoft: "rgba(242, 234, 211, 0.7)",
    accent: "#D4A158",
    monogramFill: "#D4A158",
    monogramText: "#0F1A3D",
    spark: "#D4A158",
    ruleColor: "rgba(212, 161, 88, 0.4)",
    storyBg: "rgba(212, 161, 88, 0.06)",
    storyBorder: "rgba(242, 234, 211, 0.14)",
    footerDot: "#D4A158",
    ornament: "rose-vine",
    ornamentOpacity: 0.28,
    isDark: true,
  ...
  /* ── luxe collection: AETHEL + AURORA (NOCTURNE/CANDELA/MISTRAL/OLEA
       sed naming migration sonucu zaten yukarıda/aşağıda mevcut) ── */
  aethel: {
    slug: "aethel",
    name: "Aethel",
    bg: "linear-gradient(170deg, #F2EEE4 0%, #E8E3D5 55%, #DDD7C5 100%)",
    ink: "#2E3326",
    inkSoft: "rgba(46, 51, 38, 0.7)",
    accent: "#7A8A6E",
    monogramFill: "#7A8A6E",
    monogramText: "#F2EEE4",
    spark: "#9EAA8E",
    ruleColor: "rgba(122, 138, 110, 0.4)",
    storyBg: "rgba(122, 138, 110, 0.06)",
    storyBorder: "rgba(46, 51, 38, 0.10)",
    footerDot: "#7A8A6E",
    ornament: "eucalyptus",
  ...
  mistral: {
    slug: "mistral",
    name: "Mistral",
    bg: "linear-gradient(170deg, #F4F1EA 0%, #E8E3D8 55%, #D8D2C3 100%)",
    ink: "#1F3848",
    ...
    monogramText: "#F4F1EA",
    spark: "#7BA8BD",
    ruleColor: "rgba(74, 126, 148, 0.4)",
    storyBg: "rgba(74, 126, 148, 0.07)",
    storyBorder: "rgba(31, 56, 72, 0.10)",
    footerDot: "#4A7E94",
    ornament: "fern",
  ...
  "candela": {
    slug: "candela",
    name: "Candéla",
    bg: "linear-gradient(170deg, #4A1521 0%, #3A0F19 55%, #4A1521 100%)",
    ink: "#F2EAD3",
    inkSoft: "rgba(242, 234, 211, 0.7)",
    accent: "#D9B36A",
    monogramFill: "#D9B36A",
    monogramText: "#4A1521",
    spark: "#D9B36A",
    ruleColor: "rgba(217, 179, 106, 0.45)",
    storyBg: "rgba(217, 179, 106, 0.08)",
    storyBorder: "rgba(242, 234, 211, 0.14)",
    footerDot: "#D9B36A",
    ornament: "rose-vine",
    ornamentOpacity: 0.30,
